...
use App\Validator\HomeValidator\UpdateHomeValidator;

class UpdateHomeRequest extends Request implements RequestInterface
{
...
public function __construct()
{
    ...
    $this->validator = new UpdateHomeValidator($this);
}
