...
use App\Validator\HomeValidator\GetAllHomeValidator;

class GetAllHomeRequest extends Request implements RequestInterface
{
...
public function __construct()
{
    ...
    $this->validator = new GetAllHomeValidator($this);
}
