...
use App\Validator\HomeValidator\EditHomeValidator;

class EditHomeRequest extends Request implements RequestInterface
{
...
public function __construct()
{
    ...
    $this->validator = new EditHomeValidator($this);
}
